...
type PmsProduct struct {
	...
	FeightTemplateId           int64     `gorm:"column:feight_template_id;type:bigint;comment:商品运费模板id;not null;" json:"feight_template_id"`                                              // 商品运费模板id
	...
	DeleteStatus               int32     `gorm:"column:delete_status;type:int(1);comment:删除状态：0->未删除；1->已删除;not null;" json:"delete_status"`                                              // 删除状态：0->未删除；1->已删除
	...
	RecommandStatus            int32     `gorm:"column:recommand_status;type:int(1);comment:推荐状态；0->不推荐；1->推荐;not null;" json:"recommand_status"`                                         // 推荐状态；0->不推荐；1->推荐
	...
	Sale                       int32     `gorm:"column:sale;type:int;comment:销量;not null;" json:"sale"`                                                                                   // 销量
	...
	LowStock                   int32     `gorm:"column:low_stock;type:int;comment:库存预警值;not null;" json:"low_stock"`                                                                      // 库存预警值
	...
	ProductCategoryIdArray     string    `gorm:"column:product_category_id_Array;type:varchar(64);comment:商品分类id字符串;not null;" json:"product_category_id_Array"`                          // 商品分类id字符串
}
